...
public class UserController {
    ...
    public void sendMessage2(Message message) {
        Request request = new Request(ActionFlags.VIDEO_CALL, message);
        send(request);
    }
    
    public void videoCall(VideoRequest videoRequest) {
        Request request = new Request(ActionFlags.VIDEO_CALL, videoRequest);
        send(request);
    }
